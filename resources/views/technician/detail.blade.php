                ...
                <div class="row mb-2">
                    ...
                    {{ $task->status == 'DITUGASKAN'
                        ...
                        : ($task->status == 'SEDANG_DIKERJAKAN'
                            ? 'badge-info'
                            : ($task->status == 'MENUNGGU_SPAREPART'
                                ? 'badge-secondary'
                                : ($task->status == 'SPAREPART_TERSEDIA'
                                    ? 'badge-primary'
                                    : ($task->status == 'SELESAI'
                                        ? 'badge-success'
                                        : 'badge-light')))) }}">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                @if ($task->status === 'SEDANG_DIKERJAKAN')
                    <a href="{{ route('tasks.sparepart.form', $task->id) }}" class="btn btn-warning mb-2">
                        <i class="fas fa-cogs"></i> Ajukan Sparepart
                    </a>

                    <button class="btn btn-success float-right" data-toggle="modal" data-target="#finishModal">
                ...
                @if ($task->status === 'SPAREPART_TERSEDIA')
                    <button class="btn btn-success" data-toggle="modal" data-target="#finishModal1">
                        <i class="fas fa-check"></i> Selesaikan Perbaikan
                    </button>
                @endif
